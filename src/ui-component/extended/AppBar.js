                    ...
                    <Toolbar>
                        <Typography component="div" sx={{ flexGrow: 1, textAlign: 'left' }}>
                            <Link to="#" component="div">
                                <img src={MainLogo} height="70px" alt="Pure Element" />
                            </Link>
                        </Typography>
                        <Stack direction="row" sx={{ display: { xs: 'none', sm: 'block' } }} spacing={2}>
                            ...
                            <Button color="inherit" component={RouterLink} to="/home" target="_blank">
                                Packages
                            </Button>
                            <Button color="inherit" component={RouterLink} to="/home" target="_blank">
                                About
                            ...
                            <Button component={RouterLink} to="/login" disableElevation variant="contained" color="primary">
                                Login
                            </Button>
                        </Stack>
