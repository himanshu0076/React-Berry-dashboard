        ...
        <>
            ...
            >
                <Avatar
                    ...
                    color="inherit"
                >
                    {language === 'usd' && <PaidIcon sx={{ fontSize: '1.3rem' }} />}
                    {language === 'euro' && <PaidIcon sx={{ fontSize: '1.3rem' }} />}
                    {language === 'pound' && <PaidIcon sx={{ fontSize: '1.3rem' }} />}
                </Avatar>
            </Box>
                                    ...
                                    >
                                        ...
                                        >
                                            <ListItemText
                                                primary={
                                                    <Grid container>
                                                        <Typography color="textPrimary">Euro</Typography>
                                                    </Grid>
                                                }
                                            />
                                        </ListItemButton>
                                        <ListItemButton
                                            selected={language === 'pound'}
                                            onClick={(event) => handleListItemClick(event, 'ro')}
                                        >
                                            <ListItemText
                                                primary={
                                                    <Grid container>
                                                        <Typography color="textPrimary">Pound</Typography>
                                                    </Grid>
                                                }
                                            />
                                        </ListItemButton>
